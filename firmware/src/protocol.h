...
#define CMD_SET_OFFSET_CUSTOM_X 'J'
#define CMD_SET_OFFSET_CUSTOM_Y 'K'
#define CMD_SET_OFFSET_CUSTOM_Z 'L'
#define CMD_SEL_OFFSET_TABLE 'M'
#define CMD_SEL_OFFSET_CUSTOM 'N'
#define CMD_OFFSET_STORE 'O'
#define CMD_OFFSET_RESTORE 'P'

#define CMD_AIR_ENABLE 'Q'
#define CMD_AIR_DISABLE 'R'
#define CMD_AUX_ENABLE 'S'
#define CMD_AUX_DISABLE 'T'
